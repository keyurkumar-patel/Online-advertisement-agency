...
namespace project
{
    public partial class adminradio : System.Web.UI.Page
    {
        ...
        public void display()
        {
            ...
            SqlCommand cmd = new SqlCommand("select * from radio", con);
            con.Open();
        ...
        protected void ADD_Click(object sender, System.EventArgs e)
        {
            ...
            string sql = "Insert into adminradio(station,program,ptime,pduration) Values('" + TextBox1.Text + "','" + TextBox2.Text + "','" + TextBox4.Text + "','" + TextBox5.Text + "')";
        ...
        private void DataGrid1_EditCommand(object source, System.Web.UI.WebControls.DataGridCommandEventArgs e)
        {
            ...
            if (e.CommandName == "EDIT")
            {
                ...
                try
                {
                    string Command = "SELECT * FROM radio WHERE uploadcontent='" + filename + "'";
        ...
        private void DataGrid1_DeleteCommand(object source, System.Web.UI.WebControls.DataGridCommandEventArgs e)
        {
            ...
            con.Open();
            SqlCommand cmd = new SqlCommand("delete  from radio where cid='" + s + "'", con);
            cmd.CommandType = CommandType.Text;
        ...
        private void DataGrid2_DeleteCommand(object source, System.Web.UI.WebControls.DataGridCommandEventArgs e)
        {
            ...
            con.Open();
            SqlCommand cmd = new SqlCommand("delete  from adminradio where program='" + s + "'", con);
            cmd.CommandType = CommandType.Text;
        ...
        private void DataGrid2_UpdateCommand(object source, System.Web.UI.WebControls.DataGridCommandEventArgs e)
        {
            ...
            string updt = "update adminradio set station=@station,program=@program,ptime=@ptime,pduration=@pduration where program=@program ";
        ...
        private void DataGrid1_SortCommand(object source, System.Web.UI.WebControls.DataGridSortCommandEventArgs e)
        {
            ...
            da.Fill(ds, "radio");
            con.Open();
            DataView dv = new DataView(ds.Tables["radio"]);
            if ((numberdiv % 2) == 0)
            {
