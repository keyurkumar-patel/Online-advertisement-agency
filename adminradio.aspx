<%@ Page Language="C#" MasterPageFile="~/adminmaster.Master" AutoEventWireup="true" CodeBehind="adminradio.aspx.cs" Inherits="project.adminradio" Title="Untitled Page" %>
...
<div id="templatemo_main_top_sb"></div>
    <div id="templatemo_main_sb">
                    ...
                    <form id="Form1" method="post" name="adminradio" action="#" runat="server">
 <div>
 ...
 <table>
           ...
           <tr>
                <td colspan="3">
                    &nbsp;<asp:Label ID="Label1" runat="server" Font-Bold="True" Font-Names="Arial" ForeColor="DarkSeaGreen"
                        Text="Radio Registration"></asp:Label>
        <asp:DataGrid ID="DataGrid1" runat="server" AllowPaging="True" AllowSorting="True"
            ...
            <Columns>
                ...
                <asp:BoundColumn DataField="station" HeaderText="Station" SortExpression="station">
                </asp:BoundColumn>
        ...
        <br />  &nbsp;
        <asp:Label ID="Label8" runat="server" ForeColor="DarkSeaGreen" Font-Bold="True" Text="RADIO DETAILS"></asp:Label>
        ...
        <br />
            ...
            <tr>
                <td colspan="3" style="height: 24px">  &nbsp;
                    <asp:Label ID="Label7" runat="server" ForeColor="DarkSeaGreen" Font-Bold="True" Text="UPDATE RADIO DETAILS"
