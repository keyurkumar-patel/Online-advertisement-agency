...
namespace project
{
    public partial class admininternet : System.Web.UI.Page
    {
        ...
        public void display()
        {
            ...
            SqlCommand cmd = new SqlCommand("select * from internet", con);
            con.Open();
        ...
        public void display1()
        {
            ...
            display2();
            //con = new SqlConnection("server=SUTHAHAR-F92F17\\TEST;database=sample;user id=sa;pwd=sukitha");
            SqlCommand cmd = new SqlCommand("select * from admininternet", con);
            con.Open();
            cmd.CommandType = CommandType.Text;
            SqlDataAdapter da = new SqlDataAdapter(cmd);
            DataSet ds = new DataSet();
            da.Fill(ds, "admininternet");
            cmd.ExecuteReader();
        ...
        private void DataGrid1_EditCommand(object source, System.Web.UI.WebControls.DataGridCommandEventArgs e)
        {
            ...
            {
                filename = ((LinkButton)e.Item.Cells[8].FindControl("uploadcontent")).Text;
                try
                {
                    string Command = "SELECT * FROM Internet WHERE uploadcontent='" + filename + "'";
        ...
        private void DataGrid1_DeleteCommand(object source, System.Web.UI.WebControls.DataGridCommandEventArgs e)
        {
            ...
            con.Open();
            SqlCommand cmd = new SqlCommand("delete  from internet where cid='" + s + "'", con);
            cmd.CommandType = CommandType.Text;
        ...
        private void DataGrid2_DeleteCommand(object source, System.Web.UI.WebControls.DataGridCommandEventArgs e)
        {
            ...
            string s = e.Item.Cells[0].Text;
            con.Open();
            SqlCommand cmd = new SqlCommand("delete  from admininternet where website='" + s + "'", con);
            cmd.CommandType = CommandType.Text;
        ...
        private void DataGrid2_UpdateCommand(object source, System.Web.UI.WebControls.DataGridCommandEventArgs e)
        {
            ...
            website = (TextBox)e.Item.Cells[0].Controls[0];

            string updt = "update admininternet set  website=@website where  website=@website";
            SqlCommand cmd = new SqlCommand(updt, con);
            cmd.Parameters.Add("@website", website.Text);
        ...
        private void DataGrid1_SortCommand(object source, System.Web.UI.WebControls.DataGridSortCommandEventArgs e)
        {
            ...
            da.Fill(ds, "internet");
            con.Open();
            DataView dv = new DataView(ds.Tables["internet"]);
            if ((numberdiv % 2) == 0)
            {
        ...
        private void DataGrid2_SortCommand(object source, System.Web.UI.WebControls.DataGridSortCommandEventArgs e)
        {
            ...
            da.Fill(ds, "admininternet");
            con.Open();
            DataView dv = new DataView(ds.Tables["admininternet"]);
            if ((numberdiv % 2) == 0)
            {
                dv.Sort = e.SortExpression + " " + "ASC";
            }
