...
namespace project
{
    public partial class admintelevision : System.Web.UI.Page
    {
        ...
        public void display()
        {
            ...
            SqlCommand cmd = new SqlCommand("select * from television", con);
            con.Open();
            cmd.CommandType = CommandType.Text;
            SqlDataAdapter da = new SqlDataAdapter(cmd);
            DataSet ds = new DataSet();
            da.Fill(ds, "television");
            cmd.ExecuteReader();
        ...
        public void display1()
        {
            ...
            display2();
            //con = new SqlConnection("server=SUTHAHAR-F92F17\\TEST;database=sample;user id=sa;pwd=sukitha");
            SqlCommand cmd = new SqlCommand("select * from admintv", con);
            con.Open();
            cmd.CommandType = CommandType.Text;
            SqlDataAdapter da = new SqlDataAdapter(cmd);
            DataSet ds = new DataSet();
        ...
        protected void ADD_Click(object sender, System.EventArgs e)
        {
            ...
            string sql = "Insert into admintv(station,program,ptime,pduration) Values('" + TextBox1.Text + "','" + TextBox2.Text + "','" + TextBox4.Text + "','" + TextBox5.Text + "')";
        ...
        private void DataGrid1_EditCommand(object source, System.Web.UI.WebControls.DataGridCommandEventArgs e)
        {
            ...
            if (e.CommandName == "EDIT")
            {
                ...
                try
                {
                    string Command = "SELECT * FROM television WHERE uploadcontent='" + filename + "'";
        ...
        private void DataGrid1_DeleteCommand(object source, System.Web.UI.WebControls.DataGridCommandEventArgs e)
        {
            ...
            con.Open();
            SqlCommand cmd = new SqlCommand("delete  from television where cid='" + s + "'", con);
            cmd.CommandType = CommandType.Text;
        ...
        private void DataGrid2_DeleteCommand(object source, System.Web.UI.WebControls.DataGridCommandEventArgs e)
        {
            ...
            con.Open();
            SqlCommand cmd = new SqlCommand("delete  from admintv where program='" + s + "'", con);
            cmd.CommandType = CommandType.Text;
        ...
        private void DataGrid2_UpdateCommand(object source, System.Web.UI.WebControls.DataGridCommandEventArgs e)
        {
            ...
            station = (TextBox)e.Item.Cells[0].Controls[0];
            program = (TextBox)e.Item.Cells[1].Controls[0];
            ptime = (TextBox)e.Item.Cells[2].Controls[0];
            pduration = (TextBox)e.Item.Cells[3].Controls[0];
            string updt = "update admintv set station=@station,program=@program,ptime=@ptime,pduration=@pduration where program=@program ";
            SqlCommand cmd = new SqlCommand(updt, con);
            cmd.Parameters.Add("@station", station.Text);
            cmd.Parameters.Add("@program", program.Text);
            cmd.Parameters.Add("@ptime", ptime.Text);
            cmd.Parameters.Add("@pduration", pduration.Text);
        ...
        private void DataGrid1_SortCommand(object source, System.Web.UI.WebControls.DataGridSortCommandEventArgs e)
        {
            ...
            da.Fill(ds, "television");
            con.Open();
            DataView dv = new DataView(ds.Tables["television"]);
            if ((numberdiv % 2) == 0)
            {
        ...
        private void DataGrid2_SortCommand(object source, System.Web.UI.WebControls.DataGridSortCommandEventArgs e)
        {
            ...
            da.Fill(ds, "admintv");
            con.Open();
            DataView dv = new DataView(ds.Tables["admintv"]);
            if ((numberdiv % 2) == 0)
            {
                dv.Sort = e.SortExpression + " " + "ASC";
            }
