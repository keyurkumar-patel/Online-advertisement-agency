<%@ Page Language="C#" MasterPageFile="~/adminmaster.Master" AutoEventWireup="true" CodeBehind="admininternet.aspx.cs" Inherits="project.admininternet" Title="Untitled Page" %>
...
<div id="templatemo_main_top_sb"></div>
    <div id="templatemo_main_sb">
                    ...
                    <form id="Form1" method="post" name="admininternet" action="#" runat="server">
 <div>
 ...
 <table>
            ...
            <tr>
                <td colspan="3">
                    &nbsp;<asp:Label ID="Label2" runat="server" ForeColor="DarkSeaGreen" Font-Bold="True" Font-Names="Arial" 
                        Text="Internet Ads Registration"></asp:Label>
        <asp:DataGrid ID="DataGrid1" runat="server" AllowPaging="True" AllowSorting="True"
            AutoGenerateColumns="False" BackColor="White" Height="119px" 
            PageSize="5" Width="915px" BorderColor="#CCCCCC" BorderStyle="None" BorderWidth="1px" CellPadding="3">
            ...
            <Columns>
                ...
                <asp:BoundColumn DataField="website" HeaderText="Websites" SortExpression="website">
                </asp:BoundColumn>
        ...
        <br />&nbsp;<asp:Label ID="Label8" runat="server" ForeColor="DarkSeaGreen" Font-Bold="True"  Text="WEBSITE  DETAILS"></asp:Label>
        ...
        <table>
            <tr>
                <td colspan="3" style="height: 24px">
                    &nbsp;<asp:Label ID="Label7" runat="server" ForeColor="DarkSeaGreen" Font-Bold="True" Text="UPDATE WEBSITE DETAILS"
                        Width="195px"></asp:Label></td>
            </tr>
            <tr>
                <td style="width: 66px; height: 24px">
                    <asp:Label ID="Label3" runat="server" Text="Website"></asp:Label></td>
