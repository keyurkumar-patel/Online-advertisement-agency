<%@ Page Language="C#" MasterPageFile="~/Master.Master" AutoEventWireup="true" CodeBehind="Radio.aspx.cs" Inherits="project.Radio" Title="Untitled Page" %>
        ...
        <div id="templatemo_bottom">
     	<div class="col_allw300">
           ...
           <ul class="bottom_list">
            ...
            <li><a href="Radio.aspx" class="selected">Radio</a></li><br /><br /><br />
         ...
         <tr>
                <td colspan="2" style="height: 1px">
                    <span style="font-size: 18pt">&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; <span
                        style="font-family: Times New Roman">&nbsp; &nbsp;<b> <span style="color:Green">
                              Advertisethrough Redio</span></b></span></span><br />
                        <br />
            ...
            <tr>
                <td style="width: 1px; height: 24px">
                    <asp:Label ID="Label1" runat="server" Text="Station:" Width="180px"></asp:Label></td>
            ...
            <tr>
                <td style="width: 1px; height: 36px">
                    <asp:Label ID="Label7" runat="server" Text="Broadcasting Time:" Width="189px"></asp:Label></td>
            ...
            <tr>
                ...
                <td style="width: 281px; height: 37px">
                    ...
                    <asp:Label ID="Label15" runat="server" Font-Names="Times New Roman" ForeColor="Red"
                        Style="left: 347px; position: absolute; top: 429px" Width="195px"></asp:Label>
                    &nbsp;
                </td>
            </tr>
            <tr>
            ...
            <tr>
                <td style="width: 1px; height: 28px">
                    <asp:Label ID="Label12" runat="server" Text="Upload Your File" Width="150px"></asp:Label></td>
                <td style="width: 281px; height: 28px">
          ...
          <table style="left: 1000px; width: 208px; position: absolute; top: 300px">
            ...
            <tr>
                <td>
                    <asp:Image ID="Image1" runat="server" ImageUrl="~/images/media/r1.jpg" /></td>
            </tr>
             <tr><td></td></tr><tr><td></td></tr>
           <tr>
                <td>
                    <asp:Image ID="Image2" runat="server" ImageUrl="~/images/media/r2.jpg" /></td>
            </tr>
            <tr><td></td></tr><tr><td></td></tr>
            <tr>
                <td>
                    <asp:Image ID="Image3" runat="server" ImageUrl="~/images/media/r3.jpg" /></td>
            </tr>
              <tr><td></td></tr><tr><td></td></tr>
              <tr>
                <td>
                    <asp:Image ID="Image4" runat="server" ImageUrl="~/images/media/r4.jpg" /></td>
            </tr>
        </table>       
                     </div>
                    </form>
