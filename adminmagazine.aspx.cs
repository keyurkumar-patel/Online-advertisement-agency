...
namespace project
{
    public partial class adminmagazine : System.Web.UI.Page
    {
        ...
        public void display()
        {
            ...
            SqlCommand cmd = new SqlCommand("select * from magazine", con);
            con.Open();
        ...
        public void display1()
        {
            ...
            display2();
            //con = new SqlConnection("server=SUTHAHAR-F92F17\\TEST;database=sample;user id=sa;pwd=sukitha");
            SqlCommand cmd = new SqlCommand("select * from adminmagazine", con);
            con.Open();
            cmd.CommandType = CommandType.Text;
            SqlDataAdapter da = new SqlDataAdapter(cmd);
            DataSet ds = new DataSet();
            da.Fill(ds, "adminmagazine");
            cmd.ExecuteReader();
        ...
        protected void ADD_Click(object sender, System.EventArgs e)
        {
            ...
            string sql = "Insert into adminmagazine(magazine) Values('" + TextBox1.Text + "')";
        ...
        private void DataGrid1_EditCommand(object source, System.Web.UI.WebControls.DataGridCommandEventArgs e)
        {
            ...
            if (e.CommandName == "EDIT")
            {
                ...
                try
                {
                    string Command = "SELECT * FROM magazine WHERE uploadcontent='" + filename + "'";
        ...
        private void DataGrid1_DeleteCommand(object source, System.Web.UI.WebControls.DataGridCommandEventArgs e)
        {
            ...
            con.Open();
            SqlCommand cmd = new SqlCommand("delete  from magazine where cid='" + s + "'", con);
            cmd.CommandType = CommandType.Text;
        ...
        private void DataGrid2_DeleteCommand(object source, System.Web.UI.WebControls.DataGridCommandEventArgs e)
        {
            ...
            string s = e.Item.Cells[0].Text;
            con.Open();
            SqlCommand cmd = new SqlCommand("delete  from adminmagazine where magazine='" + s + "'", con);
            cmd.CommandType = CommandType.Text;
        ...
        private void DataGrid2_UpdateCommand(object source, System.Web.UI.WebControls.DataGridCommandEventArgs e)
        {
            ...
            magazine = (TextBox)e.Item.Cells[0].Controls[0];

            string updt = "update adminmagazine set magazine=@magazine where magazine=@magazine ";
            SqlCommand cmd = new SqlCommand(updt, con);
            cmd.Parameters.Add("@magazine", magazine.Text);
        ...
        private void DataGrid1_SortCommand(object source, System.Web.UI.WebControls.DataGridSortCommandEventArgs e)
        {
            ...
            da.Fill(ds, "magazine");
            con.Open();
            DataView dv = new DataView(ds.Tables["magazine"]);
            if ((numberdiv % 2) == 0)
            {
        ...
        private void DataGrid2_SortCommand(object source, System.Web.UI.WebControls.DataGridSortCommandEventArgs e)
        {
            ...
            da.Fill(ds, "adminmagazine");
            con.Open();
            DataView dv = new DataView(ds.Tables["adminmagazine"]);
            if ((numberdiv % 2) == 0)
            {
                dv.Sort = e.SortExpression + " " + "ASC";
            }
